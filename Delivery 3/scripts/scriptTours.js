document.addEventListener('DOMContentLoaded', function() {
  ...
  // Fetch tour data and update price range
  fetchTours();
  updatePriceRange();
  // -----------------------Event listeners-------------------------
  ...
  // Function to setup dropdown menus
...
// Function to update price range display
  ...
  // Function to filter tours by continent
...
// Function to create tour elements
 ...
 // Function to add and remove saved tours
